...
```
```bash
https://ghp.ci/raw.githubusercontent.com/lizhe0326/AutoTV/refs/heads/master/output/user_result.m3u
```
...
```
```bash
https://ghp.ci/raw.githubusercontent.com/lizhe0326/AutoTV/refs/heads/master/output/user_result.txt
```

- 数据源：

```bash
https://ghproxy.net/raw.githubusercontent.com/lizhe0326/AutoTV/refs/heads/master/source.json
```
```bash
